...
// Import Report and Block Modals
import ReportModal from './ReportModal';
import BlockModal from './BlockModal';

// Props interface for ProfileModal
...
export default function ProfileScreen({ visible, onClose, userData: propsUserData }: ProfileModalProps) {
  ...
  useEffect(() => {
    if (visible && propsUserData?.userName) {
      loadUserData(propsUserData.userName);
    } else if (visible) {
      setProfileData(mockUserData);
    }
  }, [visible, propsUserData?.userName]);
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.userInfoSection}>
          ...
          <View style={styles.profilePictureContainer}>
            <Image source={{ uri: profileData.avatar }} style={styles.profilePicture} />
          </View>
        </View>
        ...
        <View style={styles.statsSection}>
          <Text style={styles.statsText}>
            {profileData.supporters} supporters • {profileData.supporting} supporting • {profileData.posts} posts
          </Text>
        </View>
