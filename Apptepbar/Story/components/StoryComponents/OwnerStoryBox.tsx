...
export function OwnerStoryBox({ 
  ...
  const getMediaSource = () => {
    ...
    // Return null if no media URL available
    if (!mediaUrl) {
      console.log('[KRONOP-DEBUG] ⚠️ No media URL available for story');
      return null;
    }
          ...
          <View style={styles.storyMedia}>
            {ownerStory.story_type === 'video' ? (
              mediaError ? (
                ...
                (preloadedVideoUri || getMediaSource()?.uri) ? (
                  <SimpleVideoStory 
              ...
              mediaError ? (
                ...
                getMediaSource() ? (
                  ...
                  <View style={styles.noMediaPlaceholder}>
                    <MaterialIcons name="image" size={64} color="#666" />
