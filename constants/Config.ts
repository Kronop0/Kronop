...
export const SERVER_CONFIG = {
  PORT: Number(process.env.EXPO_PUBLIC_PORT) || Number(process.env.PORT) || 10000,
  NODE_ENV: process.env.EXPO_PUBLIC_ENVIRONMENT || process.env.NODE_ENV || 'development',
  API_BASE_URL: process.env.EXPO_PUBLIC_API_BASE_URL || process.env.EXPO_PUBLIC_API_URL || process.env.EXPO_PUBLIC_BASE_URL || 'https://kronop-76zy.onrender.com',
  // WebSocket now uses same port as HTTP server (shared server)
  WS_URL: process.env.EXPO_PUBLIC_WS_URL || process.env.EXPO_PUBLIC_API_BASE_URL || process.env.EXPO_PUBLIC_API_URL || process.env.EXPO_PUBLIC_BASE_URL || 'wss://kronop-76zy.onrender.com',
};
...
export const getBaseUrl = (): string => {
  ...
  if (typeof process !== 'undefined' && process.env.EXPO_PUBLIC_BASE_URL) {
