...
const R2Thumbnail = {
  ...
  uploadThumbnail: async (imageUri, uniqueId) => {
    try {
      const fileName = `thumbnails/${uniqueId}.jpg`;
      ...
      // Return public URL - Direct R2 public URL
  ...
  // Get public URL for existing thumbnail
  getThumbnailUrl: (uniqueId) => {
    return `${r2PublicUrl}/thumbnails/${uniqueId}.jpg`;
  }
};
